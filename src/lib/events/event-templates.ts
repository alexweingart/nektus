...
export const eventTemplates: Event[] = [
  ...
  },
  {
    ...
    travelBuffer: { beforeMinutes: 30, afterMinutes: 30 },
    preferredSchedulableHours: {
      monday: [{ start: '11:30', end: '14:00' }],
      tuesday: [{ start: '11:30', end: '14:00' }],
      wednesday: [{ start: '11:30', end: '14:00' }],
      thursday: [{ start: '11:30', end: '14:00' }],
      friday: [{ start: '11:30', end: '14:00' }],
      saturday: [{ start: '11:30', end: '14:00' }],
      sunday: [{ start: '11:30', end: '14:00' }],
    },
    preferMiddleTimeSlot: true,
    status: 'template',
    createdAt: new Date(),
