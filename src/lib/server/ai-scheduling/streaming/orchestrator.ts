import { createCompletion, AI_MODELS, getModelForTask, getReasoningEffortForTask } from '@/lib/server/ai-scheduling/openai-client';
import { TEMPLATE_GENERATION_SYSTEM_PROMPT, getIntentClassificationPrompt, EVENT_SELECTION_SYSTEM_PROMPT } from '@/lib/server/ai-scheduling/system-prompts';
import { generateEventTemplateFunction } from '@/lib/server/ai-scheduling/functions/generate-event-template';
import { generateEventFunction, processGenerateEventResult } from '@/lib/server/ai-scheduling/functions/generate-event';
import { navigateToBookingLinkFunction } from '@/lib/server/ai-scheduling/functions/navigate-to-booking';
import { editEventTemplateFunction } from '@/lib/server/ai-scheduling/functions/edit-event-template';
import { searchPlaces } from '@/lib/server/ai-scheduling/helpers/search-places';
import { getCandidateSlotsWithFallback } from '@/lib/server/calendar/scheduling';
