        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <Dialog.Description asChild>
              <Text variant="small" className="text-white/60">
                Connect your {section} calendar to enable scheduling
              </Text>
            </Dialog.Description>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-6 py-4 bg-white/10 border border-white/20 rounded-xl hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 active:scale-98"
            >
              ...
              <Text variant="base" as="span" className="text-white font-medium">
