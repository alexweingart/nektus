...
/**
 * Platform-specific Firebase service interface
 * Must be implemented by each platform:
 * - Web: src/lib/client/profile/firebase-save.ts
 * - iOS: src/lib/client/firebase/firebase-save.ts
 */
...
/**
 * Platform-specific implementation - must be set before using ProfileSaveService
 * Set this in your platform initialization code
 */
export let ClientProfileService: IClientProfileService;

export function setClientProfileService(service: IClientProfileService): void {
...
/**
 * NOTE: Platform-specific helper functions removed from shared-lib
 * These functions remain in web version (apps/web/src/lib/client/profile/save.ts):
 * - generateWhatsAppFromPhone: React/NextAuth specific
 * - syncProfileToSession: NextAuth specific
 * - silentSaveToFirebase: React ref specific
 *
 * Platforms should implement their own helpers using ProfileSaveService
 */