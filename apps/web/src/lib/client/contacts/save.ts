...
import { displayVCardInlineForIOS } from '@/lib/client/contacts/vcard';
import { detectPlatform as detectPlatformUtil, isEmbeddedBrowser } from '@/lib/client/platform-detection';
import { isPermissionError, startIncrementalAuth } from '@/lib/client/auth/google-incremental';
