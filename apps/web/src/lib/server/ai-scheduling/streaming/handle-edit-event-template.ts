import { processEditEventTemplateResult } from '@/lib/server/ai-scheduling/functions/edit-event-template';
import { applyDefaultTravelBuffer } from '@/lib/server/calendar/events';
import { timeToMinutes, minutesToTime } from '@/lib/server/calendar/time';
import { processingStateManager } from '@/lib/server/ai-scheduling/processing';
import type { OpenAIToolCall, AISchedulingRequest, TemplateHandlerResult } from '@/types/ai-scheduling';
