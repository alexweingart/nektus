...
import { ALTERNATIVE_SELECTION_SYSTEM_PROMPT, buildContextMessage } from '@/server/ai-scheduling/system-prompts';
import { buildAlternativesFormattingInstructions } from './formatting-utils';
import { getAllValidSlots } from '@/server/calendar/scheduling';
import { DAYS_TO_MS, formatEventTimeComponents } from '@/server/calendar/time';
