import { processEditEventTemplateResult } from '@/server/ai-scheduling/functions/edit-event-template';
import { applyDefaultTravelBuffer } from '@/server/calendar/events';
import { timeToMinutes, minutesToTime } from '@/server/calendar/time';
