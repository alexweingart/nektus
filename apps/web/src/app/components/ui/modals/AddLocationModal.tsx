...
import { validateCompleteAddress } from '@/server/location/address-validation';
...
export const AddLocationModal: React.FC<AddLocationModalProps> = ({
  ...
  return (
    <StandardModal
      ...
      onClose={onClose}
      title="Add Location"
      subtitle={isLoadingLocation ? 'Detecting your location...' : 'Help us find cool spots near you'}
